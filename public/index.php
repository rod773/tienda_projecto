...
<head>
    ...
    <!--
        ...
        Notice the use of "php echo $TEMPLATE_PATH;" and /wp-content/themes/tienda_projecto in the tags above.
        Both will be replaced with the URL of the `public` folder during the build (/wp-content/themes/tienda_projecto) or
        at render time (php echo $TEMPLATE_PATH;)
        Only files inside the `public` folder can be referenced like this.

        Unlike "/favicon.ico" or "favicon.ico", "/wp-content/themes/tienda_projecto/favicon.ico" will
